              ...
              <h2 className="text-2xl font-bold text-gray-800">
                {isEditing ? (
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gradient-to-r from-amber-50/50 to-yellow-50/30 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-300"
                  />
                ) : (
